...
#@pytest.mark.parametrize("id, state, date",)

def test_filter_by_state() -> None:
    """Тест с использованием стандартных значений"""
...
def test_filter_by_state_no_state() -> None:
    """Тест функции с отсутствующим значением state"""
...
def test_sort_date_non_date(sort_date_none) ->None:
    """Тест функции сортировки с отсутствием даты"""
